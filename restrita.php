        ...
        <div class="container d-flex center-ctr">
            <div class="card flex-50">
                ...
                if($alunoInfo->num_rows > 0 )
                {
                    ...
                    <form method="POST" action="alteraNota.php">
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Aluno:</label>
                            <div class="col-sm-10">
                                <select class="form-control">
                                    <option value="1"><?php echo $row["nome"]; ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="sr-only" for="inlineFormInput">N1</label>
                                <input type="text" name="nota1" class="form-control mb-2" id="inlineFormInput" placeholder="N1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">N2:</label>
                            <div class="col-sm-10">
                            <label class="sr-only" for="inlineFormInput">N2</label>
                                <input type="text" name="nota2" class="form-control mb-2" id="inlineFormInput" placeholder="N2">
                            </div>
                        </div>
